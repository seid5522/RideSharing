...
public class BaseActionBarActivity extends ActionBarActivity {
    ...
    protected static final String TAG = "com.ridesharing.BaseActionBarActivity";

    public static final String PROPERTY_REG_ID = "Flock";
    private static final String PROPERTY_APP_VERSION = "1.0";
    protected String SENDER_ID = "828246609517";
    ...
    protected SharedPreferences getGcmPreferences(Context context) {
        ...
        return getSharedPreferences("com.ridesharing",
